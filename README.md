...
This repository is a proof-of-concept for an **external Valorant cheat** using an [ESP32 S3 Dev Board - 16MB Flash, 8MB PSRAM](https://www.robotics.org.za/ESP32-S3-N16R8-EXT) board for hardware-based aimbot and triggerbot functionality over WiFi. Unlike traditional Arduino setups, this leverages the ESP32's built-in WiFi for wireless communication, reducing cable clutter and potential detection vectors.
